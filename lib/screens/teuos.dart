...
class Teuos extends StatefulWidget {
  @override
  _TeuosState createState() => _TeuosState();
}

class _TeuosState extends State<Teuos> {
  dynamic _group1 = 51;
  dynamic _group2 = 52;
  dynamic _group3 = 53;
  dynamic _group4 = 54;
  ...
  Widget myRadioListTile1(dynamic val) => RadioListTile(
        ...
        onChanged: (val) {
          setState(() {
            _group1 = val;
            sizeId = teuosSizes[val]["sizeId"];
            priceNow = teuosSizes[val]["price"];
